...
public class C01Regex {
	public static void main(String[] args) {
		...
		System.out.println("dooooooooooooog".matches(p14));
		...
		System.out.println("dog".matches(p23));
		System.out.println("dogdog".matches(p23));
		System.out.println("dogdo".matches(p23));
